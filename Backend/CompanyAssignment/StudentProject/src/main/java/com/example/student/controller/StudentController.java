...
public class StudentController {
      ...
      @Autowired
		...
		//Getting List of All Students
				@GetMapping("/getAll")
				public ResponseEntity<List<Student>> showAllCC(){
					return ResponseEntity.ok(this.service.getStudents());
				}
	...
	//For page login
      ...
      //get max marks >= 80 logic
		@GetMapping("/getMaxMarks")
		public List<Student> getMaxMarks(){
			return this.service.getStudentsMaxMarks();
		}
}
